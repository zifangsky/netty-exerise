package cn.zifangsky.netty.exercise.utils;
...
public class DateUtils {
     ...
     * @return java.time.LocalDateTime
     */
    public static LocalDateTime beforeDays(Long beforeDays){
     ...
     * @return java.time.LocalDateTime
     */
    public static Date beforeDaysDate(Long beforeDays){
        return toDate(now().minusDays(beforeDays));
    }
     ...
     * @return java.time.LocalDateTime
     */
    public static Date nextDaysDate(Long nextDays){
        return toDate(now().plusDays(nextDays));
    }
